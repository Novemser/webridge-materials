...
public class ConnectionImpl extends ConnectionPropertiesImpl implements MySQLConnection {
    ...
    /**
     * For servers lesthan 4.1.0, what character set is the metadata returned in?
     */
    ...
    public void setAutoCommit(final boolean autoCommitFlag) throws SQLException {
        if (com.webridge.Constants.ENABLE_WEBRIDGE && !WeBridgeUtils.isInsideSpManager()) {
            try {
                WeBridgeUtils.enterSpManager();
                SPInvokeManager.doSetAutoCommit(this, autoCommitFlag);
                return;
            } finally {
                WeBridgeUtils.leaveSpManager();
            }
    ...
    /**
     * @param flag failedOver The failedOver to set.
     */
    ...
    /**
     * @param flag preferSlaveDuringFailover The preferSlaveDuringFailover to set.
     */
    @Deprecated
