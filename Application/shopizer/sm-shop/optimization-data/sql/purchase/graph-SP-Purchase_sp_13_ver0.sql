DROP PROCEDURE IF EXISTS `Purchase_sp_13_ver0`;
DELIMITER $$
CREATE PROCEDURE Purchase_sp_13_ver0 (IN RS_q2_r1_col2 INT)
BEGIN
...
DECLARE M_I_RS_52_size INT DEFAULT NULL;
