...
public class SymbolicCompareToInteger extends SymbolicInteger {
  StringExpression source, expression;

  public SymbolicCompareToInteger(
      String name, int l, int u, StringExpression source, StringExpression expression) {
    super(name, l, u);
    this.source = source;
    if (expression == null) {
