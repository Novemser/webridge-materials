DROP PROCEDURE IF EXISTS `AddCart_sp_27_ver0`;
DELIMITER $$
CREATE PROCEDURE AddCart_sp_27_ver0 (IN M_L_String__unique_cart_code VARCHAR(512), IN RS_q26_r1_col1 INT, IN RS_q10_r1_col1 INT, IN RS_q2_r1_col1 INT, IN __nd__func__currentTimeMs__42__67 BIGINT, IN __nd__func__currentTimeMs__42__66 BIGINT)
BEGIN
