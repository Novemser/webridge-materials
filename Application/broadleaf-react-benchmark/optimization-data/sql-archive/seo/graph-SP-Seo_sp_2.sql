DROP PROCEDURE IF EXISTS `Seo_sp_2`;
DELIMITER $$
CREATE PROCEDURE Seo_sp_2 (IN REQUEST_PARAM_uri VARCHAR(255), IN REQUEST_HEADER_X_Locale VARCHAR(255), IN q8_res1_col_customerim0___customer_id__CUSTOMER1_40_ BIGINT)
BEGIN
