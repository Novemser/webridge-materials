                ...
                <div className='row'>
                    ...
                    <div className="col-sm-6">
                        ...
                        {!isEmpty(currentlyUsedPayment) ? (
                            <ReadOnlyCreditCard
                                cardType={find(currentlyUsedPayment.additionalFields, { key: 'CARD_TYPE' }).value}
                                lastFour={find(currentlyUsedPayment.additionalFields, { key: 'LAST_FOUR' }).value}
                                expDate={find(currentlyUsedPayment.additionalFields, { key: 'EXP_DATE' }).value}/>
                        ) : (
                            <ReadOnlyCreditCard
