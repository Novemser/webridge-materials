...
const Cart = ({
    ...
    const hasOrderItems = !isEmpty(orderItems)
    return (
        <div styleName='Cart'>
                    ...
                    {hasOrderItems && (
                        <div className='col-lg-8'>
                            <div className='card' styleName='Cart__itemSummary'>
                                ...
                                <div>
                                    {orderItems.filter(o => !o.parentOrderItemId).map(orderItem => (
...
const fetchMissingProductsIfNeeded = props => {
    ...
    if (orderItems) {
        const missingProducts = orderItems.filter(o => !o.parentOrderItemId && !o.product).map(o => o.productId)
