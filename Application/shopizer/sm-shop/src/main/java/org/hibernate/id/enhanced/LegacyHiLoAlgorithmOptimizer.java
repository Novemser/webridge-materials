...
public class LegacyHiLoAlgorithmOptimizer extends AbstractOptimizer {
    ...
    public static boolean REGENERATE = true; // not use global id pool
    @Override
    public synchronized Serializable generate(AccessCallback callback) {
        final GenerationState generationState = locateGenerationState( callback.getTenantIdentifier() );

        if ( generationState.lo > generationState.maxLo || REGENERATE) {
    ...
    public GenerationState locateGenerationState(String tenantIdentifier) {
