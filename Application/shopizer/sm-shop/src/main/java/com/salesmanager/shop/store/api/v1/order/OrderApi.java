...
public class OrderApi {
	...
	public PersistableOrder checkout(@PathVariable final String code, @Valid @RequestBody PersistableOrder order,
		...
		try {
			...
			System.symbolize(order, "order");
//			SPInvokeManager.storeParam("M_L_String__265", code);
			SPInvokeManager.storeParam("M_L_String__order_com_salesmanager_shop_model_order_v1_PersistableOrder_currency", order.getCurrency());
			SPInvokeManager.storeParam("M_L_String__order_com_salesmanager_shop_model_order_v1_PersistableOrder_com_salesmanager_shop_model_order_transaction_PersistablePayment_paymentModule", order.getPayment().getPaymentModule());
