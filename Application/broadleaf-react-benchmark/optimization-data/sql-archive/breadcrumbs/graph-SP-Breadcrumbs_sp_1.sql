DROP PROCEDURE IF EXISTS `Breadcrumbs_sp_1`;
DELIMITER $$
CREATE PROCEDURE Breadcrumbs_sp_1 (IN REQUEST_TOKEN__FIELD_username VARCHAR(255), IN REQUEST_HEADER_X_Locale VARCHAR(255))
BEGIN
