...
public class IntegerConstant extends LinearIntegerExpression {
  ...
  public IntegerConstant(long i, boolean isRef) {
    value = i;
    this.isRef = isRef;
  }

  public static IntegerExpression nullRef() {
    return new IntegerConstant(0, true);
  }
  ...
  public IntegerExpression _div(IntegerExpression e) {
    ...
    if (e instanceof IntegerConstant) {
      ...
      else return new IntegerConstant(value / ic.value);
    }
  ...
  public IntegerExpression _mul(IntegerExpression e) {
    ...
    if (e instanceof IntegerConstant) {
      ...
      return new BinaryLinearIntegerExpression(this, Operator.MUL, e);
    } else {
      return super._mul(e);
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    return value == that.value && isRef == that.isRef;
  }

  @Override
  public int hashCode() {
    return Objects.hash(value, isRef);
  }

  public String toString() {
    return isRef ? (value == 0 ? "REF_NULL" : "CONST_REF_" + value) : "CONST_" + value;
  }
