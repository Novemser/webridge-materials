DROP PROCEDURE IF EXISTS `Add_sp_43_ver0`;
DELIMITER $$
CREATE PROCEDURE Add_sp_43_ver0 (IN M_J_field_order_item_com_broadleafcommerce_rest_api_wrapper_OrderItemWrapper_java_lang_Long_value INT)
BEGIN
