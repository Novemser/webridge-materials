...
SQLNode {
    ...
    parameters={FROM_UNIXTIME((((__nd__func__currentTimeMs__42__67 / 1000) * 1000) / 1000)):DATETIME, FROM_UNIXTIME((((__nd__func__currentTimeMs__42__106 / 1000) * 1000) / 1000)):DATETIME, NULL:VARCHAR, RS_q10_r1_col1:BIGINT, "127.0.0.1":VARCHAR, RS_q2_r1_col1:INT, NULL:BIGINT, NULL:DATETIME, NULL:VARCHAR, M_L_String__unique_cart_code:VARCHAR, (RS_q26_r1_col1 * 50):BIGINT},
    retVals={}
}
