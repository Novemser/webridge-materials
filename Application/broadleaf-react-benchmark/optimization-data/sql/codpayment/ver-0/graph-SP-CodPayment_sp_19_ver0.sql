DROP PROCEDURE IF EXISTS `CodPayment_sp_19_ver0`;
DELIMITER $$
CREATE PROCEDURE CodPayment_sp_19_ver0 ()
BEGIN

DECLARE QUERY_ID_0_TXN INT DEFAULT NULL;
DECLARE q2_i1 VARCHAR(512) DEFAULT NULL;
DECLARE QUERY_ID_1 INT DEFAULT NULL;
DECLARE RS_q114_r1_col1 BIGINT DEFAULT NULL;
...
DECLARE M_I_RS_2062_rowCount INT DEFAULT NULL;
...
FETCH cursor_1 INTO RS_q114_r1_col1;
END IF;
...
SELECT cursor_cnt_1,RS_q114_r1_col1;
SET M_I_RS_114_size = cursor_cnt_1;
END IF;
IF TRUE THEN
IF cursor_cnt_1 > 0 THEN
SET q3_i1 = (RS_q114_r1_col1+50);
SET q3_i2 = RS_q114_r1_col1;
SET q3_i3 = 'EmailTrackingImpl';
SET QUERY_ID_2 = 2;
SAVEPOINT trace0_p8;
UPDATE SEQUENCE_GENERATOR SET ID_VAL = q3_i1 WHERE ID_VAL = q3_i2 AND ID_NAME = q3_i3;
SET M_I_RS_2062_rowCount = ROW_COUNT();
SELECT M_I_RS_2062_rowCount;
END IF;
END IF;
