		...
		try {
			...
			if(merchantConfiguration!=null) {
				...
				if(!StringUtils.isBlank(merchantConfiguration.getValue())) {
					// TODO
					// workaround, jpf is not able to run the decrypt function
					String decrypted = "[{\"moduleCode\":\"moneyorder\",\"active\":true,\"defaultSelected\":true,\"environment\":\"PROD\",\"integrationKeys\":{\"address\":\"<p>\\r\\n\\tHi this is mony order<\\/p>\\r\\n\"}}]";//encryption.decrypt(merchantConfiguration.getValue());
