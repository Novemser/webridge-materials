...
import webridge.wbridge.symbc.numeric.visitors.CollectVariableVisitor;
import java.io.Serializable;
import java.util.HashSet;
import java.util.Map;
import java.util.Set;

public class StringConstraint implements Serializable {
  ...
  public boolean contradicts(StringConstraint o) {
    if (left != null) {
      return left.equals(o.left) && comp.equals(o.comp.not()) && right.equals(o.right);
    } else {
      return comp.equals(o.comp.not()) && right.equals(o.right);
    }
  }

  public int hashCode() {
    if (left != null) return left.hashCode() ^ comp.hashCode() ^ right.hashCode();
    else return comp.hashCode() ^ right.hashCode();
  }
  ...
  public StringConstraint copy() {
    return new StringConstraint(getLeft(), getComparator(), getRight());
  }
}
