...
public class MathRealExpression extends RealExpression {
  ...
  public String stringPC() {
    if (op == MathFunction.SIN
        || op == MathFunction.COS
        || op == MathFunction.EXP
        || op == MathFunction.ASIN
        || op == MathFunction.ACOS
        || op == MathFunction.ATAN
        || op == MathFunction.LOG
        || op == MathFunction.TAN
        || op == MathFunction.SQRT) return "(" + op.toString() + "(" + arg1.stringPC() + "))";
  ...
  public String toString() {
    if (op == MathFunction.SIN
        ...
        || op == MathFunction.LOG
        || op == MathFunction.TAN
        || op == MathFunction.SQRT) return op.toString() + "(" + arg1.toString() + ")";
    else // op == MathFunction.POW || op == MathFunction.ATAN2
