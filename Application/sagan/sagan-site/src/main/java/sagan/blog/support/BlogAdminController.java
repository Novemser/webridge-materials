...
class BlogAdminController {
    ...
    public String createPost(Principal principal, @Valid PostForm postForm, BindingResult bindingResult, Model model) {
        if (bindingResult.hasErrors()) {
            ...
            if (principal != null) {
                memberProfile = teamRepository.findById(new Long(principal.getName()));
            } else {
                memberProfile = new MemberProfile();
                memberProfile.setUsername("springcentral");
            }
    ...
    public String updatePost(@PathVariable Long postId, @Valid PostForm postForm, BindingResult bindingResult,
                             Model model) {
        System.symbolize(postId, "POST_ID");
        System.symbolize(postForm.getTitle(), "POST_TITLE");
        System.symbolize(postForm.getContent(), "POST_CONTENT");

        SPInvokeManager.storeParam("M_J_field_POST_ID_java_lang_Long_value", postId);
        SPInvokeManager.storeParam("M_L_String__POST_TITLE", postForm.getTitle());
        SPInvokeManager.storeParam("M_L_String__POST_CONTENT", postForm.getContent());
