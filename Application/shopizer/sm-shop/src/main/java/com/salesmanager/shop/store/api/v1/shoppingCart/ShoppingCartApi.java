...
public class ShoppingCartApi {
  ...
  @Inject public StoreFacade storeFacade;

  @Inject public UserFacade userFacade;
  ...
  public @ResponseBody ReadableShoppingCart getByCode(
    ...
    try {
      System.symbolize(code, "cart_code");
  ...
  public @ResponseBody ReadableShoppingCart addToCart(
    ...
    try {
      System.symbolize(id, "cart_id");
      System.symbolize(shoppingCartItem, "item");
      SPInvokeManager.storeParam("M_I_field_item_com_salesmanager_shop_model_shoppingcart_PersistableShoppingCartItem_quantity", shoppingCartItem.getQuantity());
      SPInvokeManager.storeParam("M_J_field_item_com_salesmanager_shop_model_shoppingcart_PersistableShoppingCartItem_java_lang_Long_value", shoppingCartItem.getProduct());
      // lookup customer
