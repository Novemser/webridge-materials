...
public class SymbolicReal extends RealExpression {
  ...
  public double solution = UNDEFINED;

  private int unique_id;

  private static String SYM_REAL_SUFFIX = "_SYMREAL"; // C: what is this?
  private String name;
  ...
  public SymbolicReal(String s, double l, double u, Byte type) {
    super();
    unique_id = MinMax.UniqueId++;
    _min = l;
    _max = u;
  ...
  public double solution() {
    if (PathCondition.flagSolved) {
      if (solution == UNDEFINED) {
        // return a random value in concolic mode; note that if the solution happens to be exactly
        // the value of UNDEFINED, then there is a bug
        double d;
        ...
        // the solution is unrelated to this symbolic value, return whatever value
        // is ok
        solution = 0;
      }
      return solution;
