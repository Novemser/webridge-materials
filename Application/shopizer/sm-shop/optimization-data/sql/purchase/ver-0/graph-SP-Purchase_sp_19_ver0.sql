DROP PROCEDURE IF EXISTS `Purchase_sp_19_ver0`;
DELIMITER $$
CREATE PROCEDURE Purchase_sp_19_ver0 ()
BEGIN
...
DECLARE M_I_RS_1191_rowCount INT DEFAULT NULL;
...
SET cursor_cnt_1 = 0;
BEGIN
DECLARE cursor_1 CURSOR FOR SELECT SEQ_COUNT FROM SM_SEQUENCER WHERE SEQ_NAME = 'STATUS_HIST_ID_NEXT_VALUE' FOR UPDATE;
DECLARE CONTINUE HANDLER FOR NOT FOUND SET indicator_1 = 1;
OPEN cursor_1;
loop_1: LOOP
IF cursor_cnt_1=0 THEN
FETCH cursor_1 INTO RS_q66_r1_col1;
END IF;
...
SELECT cursor_cnt_1,RS_q66_r1_col1;
SET M_I_RS_66_size = cursor_cnt_1;
END IF;
IF TRUE THEN
IF cursor_cnt_1 > 0 THEN
SET q3_i1 = (RS_q66_r1_col1+1);
SET q3_i2 = RS_q66_r1_col1;
SET QUERY_ID_2 = 2;
SAVEPOINT trace0_p3;
UPDATE SM_SEQUENCER SET SEQ_COUNT = q3_i1 WHERE SEQ_COUNT = q3_i2 AND SEQ_NAME = 'STATUS_HIST_ID_NEXT_VALUE';
SET M_I_RS_1191_rowCount = ROW_COUNT();
SELECT M_I_RS_1191_rowCount;
END IF;
END IF;
