DROP PROCEDURE IF EXISTS `CodPayment_sp_72_ver0`;
DELIMITER $$
CREATE PROCEDURE CodPayment_sp_72_ver0 (IN __nd__func__currentTimeMs__42__219 BIGINT)
BEGIN
...
SET q1_i2 = FROM_UNIXTIME((((__nd__func__currentTimeMs__42__219/1000)*1000)/1000));
SET q1_i3 = FROM_UNIXTIME((((__nd__func__currentTimeMs__42__219/1000)*1000)/1000));
SET QUERY_ID_0 = 0;
