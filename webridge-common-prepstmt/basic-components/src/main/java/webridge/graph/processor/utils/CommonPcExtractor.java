package webridge.graph.processor.utils;
...
import webridge.symbc.string.StringConstraintWrapper;
        ...
        if (diff != null) {
          ...
          final LinearIntegerConstraint simplified =
              new LinearIntegerConstraint(
                  new SymbolicBoolean(varName), webridge.symbc.numeric.Comparator.EQ, new IntegerConstant(1));
          simplified.and = diff;
