...
LOG_DIR=/tmp/log/sagan
SCHEMA_FILE=/root/sagan/sagan_schema.sql
PERF_BASE_DIR=/root/benchmark/sagan/thpt
...
do
  sh ${WEBENCH_ROOT}/scripts/sagan/restart_web.sh
  java -Xmx16g -jar webench-1.0-SNAPSHOT.jar \
    --workload blogging --app sagan --distribution-base-dir data/blogging \
