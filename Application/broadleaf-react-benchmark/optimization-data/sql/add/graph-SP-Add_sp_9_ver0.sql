DROP PROCEDURE IF EXISTS `Add_sp_9_ver0`;
DELIMITER $$
CREATE PROCEDURE Add_sp_9_ver0 ()
BEGIN

DECLARE QUERY_ID_0_TXN INT DEFAULT NULL;
DECLARE q2_i1 VARCHAR(512) DEFAULT NULL;
DECLARE QUERY_ID_1 INT DEFAULT NULL;
DECLARE RS_q57_r1_col1 BIGINT DEFAULT NULL;
DECLARE M_I_RS_57_size INT DEFAULT NULL;
...
DECLARE M_I_RS_878_rowCount INT DEFAULT NULL;
...
END IF;
IF TRUE THEN
SET q2_i1 = 'FulfillmentGroupImpl';
SET QUERY_ID_1 = 1;
SET indicator_1 = 0;
SET cursor_cnt_1 = 0;
BEGIN
...
FETCH cursor_1 INTO RS_q57_r1_col1;
END IF;
...
SELECT cursor_cnt_1,RS_q57_r1_col1;
SET M_I_RS_57_size = cursor_cnt_1;
END IF;
IF TRUE THEN
IF cursor_cnt_1 > 0 THEN
SET q3_i1 = (RS_q57_r1_col1+50);
SET q3_i2 = RS_q57_r1_col1;
SET q3_i3 = 'FulfillmentGroupImpl';
SET QUERY_ID_2 = 2;
SAVEPOINT trace0_p3;
UPDATE SEQUENCE_GENERATOR SET ID_VAL = q3_i1 WHERE ID_VAL = q3_i2 AND ID_NAME = q3_i3;
SET M_I_RS_878_rowCount = ROW_COUNT();
SELECT M_I_RS_878_rowCount;
END IF;
END IF;
