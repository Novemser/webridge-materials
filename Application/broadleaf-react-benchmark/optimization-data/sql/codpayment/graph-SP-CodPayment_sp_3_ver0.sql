...
DELIMITER $$
CREATE PROCEDURE CodPayment_sp_3_ver0 (IN __nd__func__currentTimeMs__42__105 BIGINT, IN RS_q20_r1_col1 INT)
BEGIN
...
DECLARE M_I_RS_393_rowCount INT DEFAULT NULL;
...
SET M_I_RS_393_rowCount = ROW_COUNT();
SELECT M_I_RS_393_rowCount;
END IF;
