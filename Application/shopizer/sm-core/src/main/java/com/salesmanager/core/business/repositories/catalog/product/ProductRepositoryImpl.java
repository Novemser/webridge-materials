...
public class ProductRepositoryImpl implements ProductRepositoryCustom {
	...
	public static volatile boolean RECORD = true;
...
//			RECORD = true;
			NamedStopWatch.begin("product-res");
//			MySQLNamedStopWatch.reset("mysql-findColumn");
			Product p = (Product) q.getSingleResult();
//			System.out.println("!!! " + DBUtils.getMySQLTimerMS("mysql-findColumn"));
//			RECORD = false;
//			NamedStopWatch.end("product-hibernate");
			NamedStopWatch.end("product-res");
			return p;
