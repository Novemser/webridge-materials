DROP PROCEDURE IF EXISTS `Add_sp_73_ver0`;
DELIMITER $$
CREATE PROCEDURE Add_sp_73_ver0 (IN RS_q80_r1_col1 INT)
BEGIN
...
DECLARE M_I_RS_1105_rowCount INT DEFAULT NULL;
DECLARE cursor_cnt_0 INT DEFAULT NULL;

IF TRUE THEN
SET q1_i1 = (RS_q80_r1_col1+50);
SET q1_i2 = RS_q80_r1_col1;
SET q1_i3 = 'OrderItemPriceDetailImpl';
SET QUERY_ID_0 = 0;
SAVEPOINT trace0_p9;
UPDATE SEQUENCE_GENERATOR SET ID_VAL = q1_i1 WHERE ID_VAL = q1_i2 AND ID_NAME = q1_i3;
SET M_I_RS_1105_rowCount = ROW_COUNT();
SELECT M_I_RS_1105_rowCount;
END IF;
