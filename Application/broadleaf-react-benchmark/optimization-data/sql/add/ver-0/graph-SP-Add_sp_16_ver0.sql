...
DECLARE RS_q80_r1_col1 BIGINT DEFAULT NULL;
...
DECLARE M_I_RS_1161_rowCount INT DEFAULT NULL;
...
END IF;
IF TRUE THEN
SET q2_i1 = 'OrderItemPriceDetailImpl';
SET QUERY_ID_1 = 1;
SET indicator_1 = 0;
SET cursor_cnt_1 = 0;
BEGIN
...
FETCH cursor_1 INTO RS_q80_r1_col1;
END IF;
...
SELECT cursor_cnt_1,RS_q80_r1_col1;
SET M_I_RS_80_size = cursor_cnt_1;
END IF;
IF TRUE THEN
IF cursor_cnt_1 > 0 THEN
SET q3_i1 = (RS_q80_r1_col1+50);
SET q3_i2 = RS_q80_r1_col1;
SET q3_i3 = 'OrderItemPriceDetailImpl';
SET QUERY_ID_2 = 2;
SAVEPOINT trace0_p9;
UPDATE SEQUENCE_GENERATOR SET ID_VAL = q3_i1 WHERE ID_VAL = q3_i2 AND ID_NAME = q3_i3;
SET M_I_RS_1161_rowCount = ROW_COUNT();
SELECT M_I_RS_1161_rowCount;
END IF;
END IF;
