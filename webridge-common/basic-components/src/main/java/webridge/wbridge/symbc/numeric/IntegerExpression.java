...
public abstract class IntegerExpression extends Expression {
  ...
  public IntegerExpression _cmp(long i) {
    return new BinaryNonLinearIntegerExpression(this, Operator.CMP, new IntegerConstant(i));
  }

  public IntegerExpression _cmp_reverse(long i) {
    return new BinaryNonLinearIntegerExpression(new IntegerConstant(i), Operator.CMP, this);
  }

  public IntegerExpression _cmp(IntegerExpression e) {
    return new BinaryNonLinearIntegerExpression(this, Operator.CMP, e);
  }

  // ------------------------------------------------------

  public IntegerExpression _minus_reverse(long i) {
    return new BinaryNonLinearIntegerExpression(new IntegerConstant(i), Operator.MINUS, this);
  }

  public IntegerExpression _minus(long i) {
    // simplify
    if (i == 0) return this;
    return new BinaryNonLinearIntegerExpression(this, Operator.MINUS, new IntegerConstant(i));
  }
  ...
  public IntegerExpression _minus(IntegerExpression e) {
    ...
    return new BinaryNonLinearIntegerExpression(this, Operator.MINUS, e);
  }
  ...
  public IntegerExpression _mul(long i) {
    ...
    return new BinaryNonLinearIntegerExpression(this, Operator.MUL, new IntegerConstant(i));
  }
  ...
  public IntegerExpression _mul(IntegerExpression e) {
    ...
    return new BinaryNonLinearIntegerExpression(this, Operator.MUL, e);
  }

  public IntegerExpression _plus(long i) {
    // simplify
    if (i == 0) return this;
    return new BinaryNonLinearIntegerExpression(this, Operator.PLUS, new IntegerConstant(i));
  }
  ...
  public IntegerExpression _plus(IntegerExpression e) {
    ...
    return new BinaryNonLinearIntegerExpression(this, Operator.PLUS, e);
  }
  ...
  public IntegerExpression _shiftR(IntegerExpression i) {
    ...
    return new BinaryNonLinearIntegerExpression(this, Operator.SHIFTR, i);
  }
  ...
  public IntegerExpression _shiftL(IntegerExpression i) {
    ...
    return new BinaryNonLinearIntegerExpression(this, Operator.SHIFTL, i);
  }
  ...
  public IntegerExpression _shiftUR(IntegerExpression i) {
    ...
    return new BinaryNonLinearIntegerExpression(this, Operator.SHIFTUR, i);
  }
  ...
  public IntegerExpression _shiftR(long i) {
    if (i == 0) return this;
    return new BinaryNonLinearIntegerExpression(this, Operator.SHIFTR, new IntegerConstant(i));
  }

  public IntegerExpression _shiftL(long i) {
    if (i == 0) return this;
    return new BinaryNonLinearIntegerExpression(this, Operator.SHIFTL, new IntegerConstant(i));
  }

  public IntegerExpression _shiftUR(long i) {
    if (i == 0) return this;
    return new BinaryNonLinearIntegerExpression(this, Operator.SHIFTUR, new IntegerConstant(i));
  }

  public IntegerExpression _and(long i) {
    if (i == 0) return new IntegerConstant(0);
    return new BinaryNonLinearIntegerExpression(this, Operator.AND, new IntegerConstant(i));
  }

  public IntegerExpression _or(long i) {
    if (i == 0) return this;
    return new BinaryNonLinearIntegerExpression(this, Operator.OR, new IntegerConstant(i));
  }

  public IntegerExpression _xor(long i) {
    return new BinaryNonLinearIntegerExpression(this, Operator.XOR, new IntegerConstant(i));
  }

  public IntegerExpression _rem(long i) {
    return new BinaryNonLinearIntegerExpression(this, Operator.REM, new IntegerConstant(i));
  }

  public IntegerExpression _rem_reverse(long i) {
    // throw new RuntimeException( "## Error: Operation not supported!" );
    return new BinaryNonLinearIntegerExpression(new IntegerConstant(i), Operator.REM, this);
  }

  public IntegerExpression _rem(IntegerExpression i) {
    return new BinaryNonLinearIntegerExpression(this, Operator.REM, i);
  }

  public IntegerExpression _neg() {
    return new BinaryNonLinearIntegerExpression(new IntegerConstant(0), Operator.MINUS, this);
  }
  ...
  public IntegerExpression _div(long i) {
    ...
    assert (i != 0);
    if (i == 1) return this;
    return new BinaryNonLinearIntegerExpression(this, Operator.DIV, new IntegerConstant(i));
  }
  ...
  public IntegerExpression _div(IntegerExpression e) {
    ...
    return new BinaryNonLinearIntegerExpression(this, Operator.DIV, e);
  }

  public IntegerExpression _div_reverse(long i) {
    if (i == 0) return new IntegerConstant(0);
    return new BinaryNonLinearIntegerExpression(new IntegerConstant(i), Operator.DIV, this);
  }
