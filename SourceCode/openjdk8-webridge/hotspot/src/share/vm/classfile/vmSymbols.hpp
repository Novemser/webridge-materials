...
#define VM_SYMBOLS_DO(template, do_alias)                                                         \
  ...
  template(classLoader_name,                           "classLoader")                                             \
                                                                                                                  \
  template(_wbridge_storedprocedure_StoredProcedureManager, "webridge/storedprocedure/StoredProcedureManager")           \
...
#define VM_INTRINSICS_DO(do_intrinsic, do_class, do_name, do_signature, do_alias)                                       \
  ...
  do_intrinsic(_add_SQLTemplate_intrinsic, _wbridge_storedprocedure_StoredProcedureManager, _add_SQLTemplate, _add_SQLTemplate_signature, F_S)  \
   do_signature(_add_SQLTemplate_signature, "(webridge/sql/SymbolicSQLTemplate;)V")                      \
