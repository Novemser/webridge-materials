DROP PROCEDURE IF EXISTS `CodPayment_sp_71_ver0`;
DELIMITER $$
CREATE PROCEDURE CodPayment_sp_71_ver0 (IN __nd__func__currentTimeMs__42__216 BIGINT, IN __nd__func__currentTimeMs__42__215 BIGINT, IN __nd__func__currentTimeMs__42__183 BIGINT)
BEGIN
...
IF TRUE THEN
SET q1_i1 = FROM_UNIXTIME(((((((((((0+(__nd__func__currentTimeMs__42__215/86400000))+719163)+1)-719163)*86400000)+(((((((0+((28800000+(__nd__func__currentTimeMs__42__183%86400000))/3600000))*60)+(((28800000+(__nd__func__currentTimeMs__42__183%86400000))%3600000)/60000))*60)+((((28800000+(__nd__func__currentTimeMs__42__183%86400000))%3600000)%60000)/1000))*1000)+((((28800000+(__nd__func__currentTimeMs__42__183%86400000))%3600000)%60000)%1000)))-28800000)/1000)*1000)/1000));
SET q1_i2 = FROM_UNIXTIME(((((((((((0+(__nd__func__currentTimeMs__42__216/86400000))+719163)+-1)-719163)*86400000)+(((((((0+((28800000+(__nd__func__currentTimeMs__42__183%86400000))/3600000))*60)+(((28800000+(__nd__func__currentTimeMs__42__183%86400000))%3600000)/60000))*60)+((((28800000+(__nd__func__currentTimeMs__42__183%86400000))%3600000)%60000)/1000))*1000)+((((28800000+(__nd__func__currentTimeMs__42__183%86400000))%3600000)%60000)%1000)))-28800000)/1000)*1000)/1000));
SET q1_i3 = 'N';
SET q1_i4 = 1;
SET QUERY_ID_0 = 0;
