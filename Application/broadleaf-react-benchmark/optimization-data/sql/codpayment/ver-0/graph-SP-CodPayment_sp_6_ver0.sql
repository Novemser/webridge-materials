DROP PROCEDURE IF EXISTS `CodPayment_sp_6_ver0`;
DELIMITER $$
CREATE PROCEDURE CodPayment_sp_6_ver0 ()
BEGIN
...
DECLARE M_I_RS_641_rowCount INT DEFAULT NULL;
...
FETCH cursor_1 INTO RS_q45_r1_col1;
END IF;
...
SELECT cursor_cnt_1,RS_q45_r1_col1;
SET M_I_RS_45_size = cursor_cnt_1;
END IF;
IF TRUE THEN
IF cursor_cnt_1 > 0 THEN
SET q3_i1 = (RS_q45_r1_col1+50);
SET q3_i2 = RS_q45_r1_col1;
SET q3_i3 = 'OrderPaymentImpl';
SET QUERY_ID_2 = 2;
SAVEPOINT trace0_p2;
UPDATE SEQUENCE_GENERATOR SET ID_VAL = q3_i1 WHERE ID_VAL = q3_i2 AND ID_NAME = q3_i3;
SET M_I_RS_641_rowCount = ROW_COUNT();
SELECT M_I_RS_641_rowCount;
END IF;
END IF;
