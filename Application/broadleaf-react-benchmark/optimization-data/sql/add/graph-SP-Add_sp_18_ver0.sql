DROP PROCEDURE IF EXISTS `Add_sp_18_ver0`;
DELIMITER $$
CREATE PROCEDURE Add_sp_18_ver0 (IN RS_q8_r1_col1 INT, IN RS_q45_r1_col64 INT)
BEGIN
...
DECLARE M_I_RS_85_size INT DEFAULT NULL;
...
END IF;
IF TRUE THEN
SET q2_i1 = RS_q8_r1_col1;
SET QUERY_ID_1 = 1;
SELECT customerof0_.CUSTOMER_OFFER_ID AS CUSTOMER1_43_, customerof0_.CUSTOMER_ID AS CUSTOMER2_43_, customerof0_.OFFER_ID AS OFFER_ID3_43_ FROM BLC_CUSTOMER_OFFER_XREF customerof0_ WHERE customerof0_.CUSTOMER_ID = q2_i1;
SET M_I_RS_85_size = FOUND_ROWS();
END IF;
SELECT QUERY_ID_0,q1_i1,QUERY_ID_1,q2_i1;
