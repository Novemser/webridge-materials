DROP PROCEDURE IF EXISTS `Add_sp_10_ver0`;
DELIMITER $$
CREATE PROCEDURE Add_sp_10_ver0 ()
BEGIN
...
DECLARE RS_q62_r1_col1 BIGINT DEFAULT NULL;
DECLARE M_I_RS_62_size INT DEFAULT NULL;
...
DECLARE M_I_RS_904_rowCount INT DEFAULT NULL;
...
END IF;
IF TRUE THEN
SET q3_i1 = 'FulfillmentGroupItemImpl';
SET QUERY_ID_2 = 2;
SET indicator_2 = 0;
SET cursor_cnt_2 = 0;
BEGIN
...
FETCH cursor_2 INTO RS_q62_r1_col1;
END IF;
...
SELECT cursor_cnt_2,RS_q62_r1_col1;
SET M_I_RS_62_size = cursor_cnt_2;
END IF;
IF TRUE THEN
IF cursor_cnt_2 > 0 THEN
SET q4_i1 = (RS_q62_r1_col1+50);
SET q4_i2 = RS_q62_r1_col1;
SET q4_i3 = 'FulfillmentGroupItemImpl';
SET QUERY_ID_3 = 3;
SAVEPOINT trace0_p4;
UPDATE SEQUENCE_GENERATOR SET ID_VAL = q4_i1 WHERE ID_VAL = q4_i2 AND ID_NAME = q4_i3;
SET M_I_RS_904_rowCount = ROW_COUNT();
SELECT M_I_RS_904_rowCount;
END IF;
END IF;
