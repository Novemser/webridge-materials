...
public class BinaryNonLinearIntegerExpression extends NonLinearIntegerExpression {
    ...
    switch (op) {
      ...
      default:
        throw new RuntimeException(
            "## Error: BinaryNonLinearSolution solution: l " + l + " op " + op + " r " + r);
    }
  }
  ...
  public String toString() {
    if (toStringCache == null) {
      toStringCache = "(" + left.toString() + op.toString() + right.toString() + ")";
    }
  ...
  public boolean equals(Object o) {
    ...
    BinaryNonLinearIntegerExpression that = (BinaryNonLinearIntegerExpression) o;
    return Objects.equals(left, that.left) && op == that.op && Objects.equals(right, that.right);
  }
