DROP PROCEDURE IF EXISTS `GetCart_sp_1`;
DELIMITER $$
CREATE PROCEDURE GetCart_sp_1 (IN REQUEST_TOKEN__FIELD_username VARCHAR(255), IN REQUEST_PARAM_uri VARCHAR(255), IN REQUEST_TOKEN__FIELD_isCrossAppAuth INT, IN REQUEST_HEADER_X_Locale VARCHAR(255))
BEGIN
...
IF INSTR(REQUEST_PARAM_uri,'blcadmin')=0 THEN
...
IF REQUEST_TOKEN__FIELD_isCrossAppAuth=0 THEN
...
IF q8_res1_col_customerim0___deactivated__DEACTIVA7_40_=0 THEN
...
END IF;
END IF;
SELECT QUERY_ID_0,q1_i1,QUERY_ID_1,q2_i1,QUERY_ID_2,q3_i1,QUERY_ID_3,QUERY_ID_4,q5_i1,QUERY_ID_5,q6_i1,QUERY_ID_6,q7_i1,QUERY_ID_7,q8_i1,QUERY_ID_8_TXN,QUERY_ID_9,q10_i1,QUERY_ID_10,q11_i1,QUERY_ID_11_TXN;
