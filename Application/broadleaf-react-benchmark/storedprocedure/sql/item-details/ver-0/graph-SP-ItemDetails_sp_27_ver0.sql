DROP PROCEDURE IF EXISTS `ItemDetails_sp_27_ver0`;
DELIMITER $$
CREATE PROCEDURE ItemDetails_sp_27_ver0 (IN RS_q24_r1_col6 INT)
BEGIN
...
IF TRUE THEN
SET q1_i1 = 'Sku';
SET q1_i2 = CONVERT(RS_q24_r1_col6,CHAR);
SET q1_i3 = 'longDescription';
SET q1_i4 = 'en%';
SET QUERY_ID_0 = 0;
