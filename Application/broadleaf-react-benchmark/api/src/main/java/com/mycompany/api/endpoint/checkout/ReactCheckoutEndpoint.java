...
public class ReactCheckoutEndpoint extends com.broadleafcommerce.rest.api.endpoint.checkout.CheckoutEndpoint {
    ...
    public String performCodCheckout(HttpServletRequest request) throws Exception {
        Order cart = CartState.getCart();
        System.symbolize(cart, "cart");
        SPInvokeManager.storeParam("M_L_String__cart_org_broadleafcommerce_core_order_domain_OrderImpl_org_broadleafcommerce_common_currency_domain_BroadleafCurrencyImpl_currencyCode", "USD");
        SPInvokeManager.storeParam("M_L_String__cart_org_broadleafcommerce_core_order_domain_OrderImpl_org_broadleafcommerce_common_locale_domain_LocaleImpl_localeCode", "en_US");
