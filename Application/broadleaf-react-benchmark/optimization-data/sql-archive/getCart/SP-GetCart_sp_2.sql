...
DELIMITER $$
CREATE PROCEDURE GetCart_sp_2 (IN REQUEST_PARAM_onlyIfExists VARCHAR(255), IN q8_res1_col_customerim0___is_registered__IS_REGI17_40_ INT, IN REQUEST_TOKEN__FIELD_isCrossAppAuth INT, IN REQUEST_PARAM_uri VARCHAR(255), IN q8_res1_col_customerim0___deactivated__DEACTIVA7_40_ INT, IN q2_res1_col_localeimpl0___currency_code__CURRENCY5_82_ VARCHAR(255), IN q11_res1_col_roleimpl0___role_name__ROLE_NAM2_137_0_ VARCHAR(255), IN REQUEST_HEADER_X_Locale VARCHAR(255), IN q8_res1_col_customerim0___customer_id__CUSTOMER1_40_ BIGINT)
BEGIN
...
DECLARE q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93__scale INT DEFAULT NULL;
DECLARE q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93__intCompact BIGINT DEFAULT NULL;
DECLARE q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93__scale INT DEFAULT NULL;
DECLARE q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93__intCompact BIGINT DEFAULT NULL;
DECLARE q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93__scale INT DEFAULT NULL;
DECLARE q19_res1_col_orderimpl0___order_total__ORDER_T14_93__scale INT DEFAULT NULL;
DECLARE q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93__intCompact BIGINT DEFAULT NULL;
DECLARE q19_res1_col_orderimpl0___order_total__ORDER_T14_93__intCompact BIGINT DEFAULT NULL;
...
IF index_of(REQUEST_PARAM_uri,'//')<=-1&&LENGTH(REQUEST_PARAM_uri)>0&&(LENGTH(REQUEST_PARAM_uri)-last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1)))!=2&&(LENGTH(REQUEST_PARAM_uri)-last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1)))!=3&&last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))>0&&(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-1)))!=2&&(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-1)))=3&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,(last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-1))+1)+1,1),CHAR))!=46&&last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-1))>0&&(last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-1))-last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-1))-1)))!=2&&(last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-1))-last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-1))-1)))!=3&&last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(last_index_of_char_from(REQUEST_PARAM_uri,47,(LENGTH(REQUEST_PARAM_uri)-1))-1))-1))<=0&&0<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,0+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,0+1,1),CHAR))<=126&&1<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,1+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,1+1,1),CHAR))<=126&&2<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,2+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,2+1,1),CHAR))<=126&&3<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,3+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,3+1,1),CHAR))<=126&&4<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,4+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,4+1,1),CHAR))<=126&&5<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,5+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,5+1,1),CHAR))<=126&&6<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,6+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,6+1,1),CHAR))<=126&&7<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,7+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,7+1,1),CHAR))<=126&&8<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,8+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,8+1,1),CHAR))<=126&&9<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,9+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,9+1,1),CHAR))<=126&&10<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,10+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,10+1,1),CHAR))<=126&&11<LENGTH(REQUEST_PARAM_uri)&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,11+1,1),CHAR))>=32&&ASCII(CONVERT(SUBSTRING(REQUEST_PARAM_uri,11+1,1),CHAR))<=126&&12>=LENGTH(REQUEST_PARAM_uri)&&REQUEST_TOKEN__FIELD_isCrossAppAuth=0&&q8_res1_col_customerim0___deactivated__DEACTIVA7_40_=0&&INSTR(REQUEST_PARAM_uri,'blcadmin')=0&&INSTR(REQUEST_PARAM_uri,'\\')=0 THEN
SET QUERY_ID_0_TXN = 0;
set autocommit=1;
IF q11_res1_col_roleimpl0___role_name__ROLE_NAM2_137_0_=''=0&&q11_res1_col_roleimpl0___role_name__ROLE_NAM2_137_0_='ROLE_USER' THEN
...
IF q8_res1_col_customerim0___is_registered__IS_REGI17_40_!=0 THEN
...
IF CONCAT('^',q18_res4_col_urlhandler0___incoming_url__INCOMING2_179_) not like CONCAT('%','$') THEN
...
SET q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93__scale = get_scale(q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93_);
SET q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93__intCompact = get_int_compact(q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93_);
SET q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93__scale = get_scale(q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93_);
SET q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93__intCompact = get_int_compact(q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93_);
SET q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93__scale = get_scale(q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93_);
SET q19_res1_col_orderimpl0___order_total__ORDER_T14_93__scale = get_scale(q19_res1_col_orderimpl0___order_total__ORDER_T14_93_);
SET q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93__intCompact = get_int_compact(q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93_);
SET q19_res1_col_orderimpl0___order_total__ORDER_T14_93__intCompact = get_int_compact(q19_res1_col_orderimpl0___order_total__ORDER_T14_93_);
...
IF 2!=q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93__scale&&q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93__intCompact!=-9223372036854775808&&((u_rshift((0-q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93__intCompact),63))|(q19_res1_col_orderimpl0___total_tax__TOTAL_T16_93__intCompact>>63))=0&&2!=q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93__scale&&q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93__intCompact!=-9223372036854775808&&((u_rshift((0-q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93__intCompact),63))|(q19_res1_col_orderimpl0___total_shipping__TOTAL_S15_93__intCompact>>63))=0&&'true'=REQUEST_PARAM_onlyIfExists&&q19_res1_col_orderimpl0___order_status__ORDER_S10_93_='IN_PROCESS'&&q2_res1_col_localeimpl0___currency_code__CURRENCY5_82_='USD' THEN
IF cursor_cnt_6 > 0 THEN
...
END IF;
IF 2!=q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93__scale&&q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93__intCompact!=-9223372036854775808&&((u_rshift((0-q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93__intCompact),63))|(q19_res1_col_orderimpl0___order_subtotal__ORDER_S11_93__intCompact>>63))=0&&2!=q19_res1_col_orderimpl0___order_total__ORDER_T14_93__scale&&q19_res1_col_orderimpl0___order_total__ORDER_T14_93__intCompact!=-9223372036854775808&&((u_rshift((0-q19_res1_col_orderimpl0___order_total__ORDER_T14_93__intCompact),63))|(q19_res1_col_orderimpl0___order_total__ORDER_T14_93__intCompact>>63))=0 THEN
IF cursor_cnt_6 > 0 THEN
