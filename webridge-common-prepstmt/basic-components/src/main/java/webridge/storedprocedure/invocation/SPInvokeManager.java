...
import static webridge.storedprocedure.invocation.SPInvocationUtils.initializeSPState;
import static webridge.storedprocedure.invocation.prefetch.PrefetchUtils.initializePrefetch;
...
public class SPInvokeManager {
  ...
  public static void beginApi(String apiName) {
    ...
    if (!initializeSPState(apiName, spDefInfo, SP_API_STATE)) return;
